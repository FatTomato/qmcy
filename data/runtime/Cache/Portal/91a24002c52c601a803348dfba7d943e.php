...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('AdminAds/add');?>" target="_self">添加广告</a></li>
		</ul>
		<form action="<?php echo U('AdminAds/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span9">
					<table class="table table-bordered">
						...
						<tr>
							<th>折扣</th>
							<td><input type="text" name="post[post_discount]" id="post_discount" value="" style="width: 400px" placeholder="请输入折扣信息"></td>
						</tr>
						<tr>
							<th>活动起止时间</th>
							<td>
						...
						<tr>
							<th>商家名称</th>
							<td><input type="text" name="post[store_name]" id="store_name" value="" style="width: 400px" placeholder="请输入商家名称"></td>
						</tr>
						<tr>
							<th>商家地址</th>
							<td><input type="text" name="post[store_addr]" id="store_addr" value="" style="width: 400px" placeholder="请输入商家联系人"></td>
						</tr>
						<tr>
							<th>商家联系人</th>
							<td><input type="text" name="post[store_contact]" id="store_contact" value="" style="width: 400px" placeholder="请输入商家联系人"></td>
						</tr>
						<tr>
							<th>商家联系电话</th>
							<td><input type="text" name="post[store_phone]" id="store_phone" value="" style="width: 400px" placeholder="请输入商家联系电话"></td>
						</tr>
						<tr>
							<th>广告内容</th>
							<td>
						...
						<tr>
							<td>
								<div style="text-align: center;">
									<input type="hidden" name="smeta" id="thumb" value="">
