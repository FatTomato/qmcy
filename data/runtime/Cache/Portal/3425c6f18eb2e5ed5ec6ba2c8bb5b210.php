...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('AdminAds/index');?>">广告管理</a></li>
			<li><a href="<?php echo U('AdminAds/add');?>" target="_self">添加广告</a></li>
			<li class="active"><a href="#">广告编辑</a></li>
		</ul>
		<form action="<?php echo U('AdminAds/edit_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span9">
					<table class="table table-bordered">
						...
						<tr>
							<th>折扣</th>
							<td>
								<input type="text" name="post[post_discount]" value="<?php echo ($post['post_discount']); ?>" style="width: 400px" placeholder="请输入折扣信息">
							</td>
						</tr>
						<tr>
							<th>活动起止时间</th>
							<td>
								<input type="text" name="post[start_time]" class="js-datetime" value="<?php echo ($post['start_time']); ?>" style="width: 120px;" autocomplete="off">-
								<input type="text" class="js-datetime" name="post[end_time]" value="<?php echo ($post['end_time']); ?>" style="width: 120px;" autocomplete="off">
							</td>
						</tr>
						<tr>
							<th>商家名称</th>
							<td><input type="text" name="post[store_name]" value="<?php echo ($post['store_name']); ?>" style="width: 400px" placeholder="请输入商家名称"></td>
						</tr>
						<tr>
							<th>商家地址</th>
							<td><input type="text" name="post[store_addr]" value="<?php echo ($post['store_addr']); ?>" style="width: 400px" placeholder="请输入商家联系人"></td>
						</tr>
						<tr>
							<th>商家联系人</th>
							<td><input type="text" name="post[store_contact]" value="<?php echo ($post['store_contact']); ?>" style="width: 400px" placeholder="请输入商家联系人"></td>
						</tr>
						<tr>
							<th>商家联系电话</th>
							<td><input type="text" name="post[store_phone]" value="<?php echo ($post['store_phone']); ?>" style="width: 400px" placeholder="请输入商家联系电话"></td>
						</tr>
						<tr>
							<th>内容</th>
							<td>
						...
						<tr>
							<td>
								<div style="text-align: center;">
									<input type="hidden" name="smeta" id="thumb" value="<?php echo ($post['smeta']); ?>">
									<a href="javascript:upload_one_image('图片上传','#thumb');">
										<?php if(empty($post['smeta'])): ?><img src="/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb-preview" width="135" style="cursor: hand"/>
										<?php else: ?>
											<img src="<?php echo sp_get_image_preview_url($post['smeta']);?>" id="thumb-preview" width="135" style="cursor: hand"/><?php endif; ?>
									</a>
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('AdminAds/index');?>">返回</a>
			</div>
		</form>
	</div>
									...
									Wind.use("artDialog", function() {
										art.dialog({
											...
											button : [ {
												...
												name : '返回列表页',
												callback : function() {
													location = "<?php echo U('AdminAds/index');?>";
													return true;
												}
											} ]
										});
