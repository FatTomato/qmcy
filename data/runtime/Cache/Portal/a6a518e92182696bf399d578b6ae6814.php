...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="javascript:;">所有说明</a></li>
		...
		<form class="js-ajax-form" action="" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($ill_list)): foreach($ill_list as $key=>$vo): ?><tr>
					...
					<td>
						<a href="<?php echo U('AdminIllustrate/edit',array('id'=>$vo['id']));?>">编辑</a> | 
						<a href="<?php echo U('AdminIllustrate/delete',array('id'=>$vo['id']));?>" class="js-ajax-delete">删除</a>
					</td>
